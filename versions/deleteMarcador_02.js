...
function deletarMarcacao() {
    ...
    // Capturar o elemento pai genérico (pode ser qualquer tag)
    const elementoPai = commonAncestor.closest('p, div, span, button');
    if (!elementoPai) {
        console.log('Nenhum elemento pai encontrado.');
        return;
    }
